...
//                  let bookingViewController = main.instantiateViewController(withIdentifier: "BookingViewController")
//
//                  let sceneDelegate = self.view.window?.windowScene?.delegate as! SceneDelegate
//                  sceneDelegate.window?.rootViewController = bookingViewController
        }
